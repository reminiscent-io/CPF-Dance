...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section 
        className="relative bg-gradient-to-br from-rose-50 via-mauve-50 to-cream-50 overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative w-full px-4 sm:px-6 lg:px-8 py-8 pt-20 text-left" ref={heroContentRef}>
